 ...
 * @author aditya
 */
public class EDITvehiclelist extends javax.swing.JFrame {

    /**
     * Creates new form EDITvehiclelist
     */
    public EDITvehiclelist() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton11.setText("Add Vehicles");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S. No.", "ID", "Model", "Driver", "Driver contact", "Number"
            }
        ) {
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        new EDITuserlist().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EDITvehiclelist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EDITvehiclelist().setVisible(true);
            }
        });
    }
